    ...
    def show_add_major_dialog(self):
        ...
        def add_major():
            ...
            if self.major_var_dup.get() == "Select Major" or self.year_var_dup.get() == "Select Year":
                ...
                print("HIHI")
                handbook.duplicate_major(self.cursor, self.major_var_dup.get(), int(self.year_var_dup.get()), major_name, int(year))
                print(handbook.fetch_major_rules_verbose(self.cursor, major_name, int(year)))
